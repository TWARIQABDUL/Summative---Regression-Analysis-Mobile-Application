...
[https://summative-regression-analysis-mobile.onrender.com/docs](https://summative-regression-analysis-mobile.onrender.com/docs)

### How to Run the Mobile App
1. Ensure you have Flutter installed on your machine.
2. Navigate to the `harvest_predict` directory: `cd harvest_predict`
